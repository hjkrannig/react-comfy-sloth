...
const CheckoutForm = () => {
  ...
  // creating payment-intent-endpointconst response = axios.put{url, JSON.stringify}
  ...
  return <div>
    ...
    <form id="payment-form" onSubmit={handleSubmit}>
      ...
      <button disabled={processing || disabled || succeeded} id='submit'>
        <span id='button-text'>{processing ?
          <div className='spinner' id='spinner'></div>
          :
          'Pay'}
        </span>
      </button>
      {/* show any error happening when processing the payment */}
      {error && (
